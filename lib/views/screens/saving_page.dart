...
class SavingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Savings', style: TextStyle(letterSpacing: 1)),
        actions: [
          IconButton(
            onPressed: () async {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                onChanged: (val) {
                                  savingGoal.targetAmount = double.parse(val);
                                },
                                textInputAction: TextInputAction.next,
                              ...
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  int id = await DbHelper.dbHelper.insertSaving(
                                    saving: savingGoal,
                                  );
        ...
        child: Column(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Consumer<SavingsController>(
                    builder: (context, sav, child) {
                      double total = sav.transactionListGoal.fold(
                        0,
            ...
            Expanded(
              child: Consumer<SavingsController>(
                builder: (context, sav, child) {
                  return sav.savingsGoal.isEmpty
                      ? const Center(
                        child: Text(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(
                                PageTransition(
                                  ...
                                  alignment:
                                      Alignment
                                          .center, // or any other alignment
                                  child: SavingGoalPage(argument: index),
                                ),
                              );
                            ...
                            child: SavingTile(
                              ...
                              progressAmount:
                                  sav.savingsGoal[index].currentProgress,
